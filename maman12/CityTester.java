public class CityTester
{
    public static void main(String[] args) {
        ...
        City city1=new City("Dimona",15,9,1955,10,15,2,70, 3,4);
        ...
        System.out.println(city1.addResidents(-100000));
        System.out.println("\tNumber of residents of city1 (after adding -100000):"+city1.getNumOfResidents());
